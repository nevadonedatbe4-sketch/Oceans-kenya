  ...
  return (
    <div className="space-y-6">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-xs font-inter transition-all cursor-pointer whitespace-nowrap ${
                !isCustom && rangeKey === key
                  ? 'bg-[#5eead4] text-[#001731] lg:bg-[#0d5959] lg:text-white'
                  : 'bg-[#012144] lg:bg-white border border-[#1c3a5e] lg:border-[#f0f0f0] text-[#9ca3af] lg:text-[#636363] hover:text-white lg:hover:text-[#001731]'
              }`}
            >
              {range.label}
            </button>
        ...
        {isCustom && (
          <div className="flex items-center gap-2 flex-wrap">
            <input
              ...
              className="px-3 py-1.5 border border-[#1c3a5e] lg:border-[#f0f0f0] bg-[#012144] lg:bg-white rounded-lg text-xs font-inter text-white lg:text-[#001731] focus:outline-none focus:border-[#5eead4] lg:focus:border-[#0d5959]"
            />
            <span className="text-xs font-inter text-[#6b7280] lg:text-[#636363]">to</span>
            <input
              type="date"
              value={customTo}
            ...
            <button
              ...
              className="px-3 py-1.5 bg-[#5eead4] text-[#001731] lg:bg-[#0d5959] lg:text-white rounded-lg text-xs font-inter cursor-pointer whitespace-nowrap"
            >
              Apply
            </button>
          </div>
        ...
        {loading ? (
          Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="bg-white rounded-xl border border-[#f0f0f0] p-5">
              <div className="h-3 w-24 bg-[#f7f8fa] rounded animate-pulse mb-2" />
              <div className="h-7 w-16 bg-[#f7f8fa] rounded animate-pulse" />
            </div>
          ))
        ) : data ? (
          <>
            <div className="relative bg-[#012144] lg:bg-white rounded-xl overflow-hidden p-5">
              <div className="absolute top-0 left-0 right-0 h-0.5 bg-[#5eead4] lg:bg-[#0d5959]" />
              <p className="text-xs font-inter text-[#6b7280] lg:text-[#636363] uppercase tracking-wider">New Leads</p>
              <p className="text-2xl font-inter font-bold text-white lg:text-[#001731] mt-1">{data.leadsOverTime.reduce((sum, l) => sum + l.count, 0)}</p>
              <p className="text-xs font-inter text-[#6b7280] lg:text-[#636363] mt-1">In selected period</p>
            </div>
            <div className="relative bg-[#012144] lg:bg-white rounded-xl overflow-hidden p-5">
              <div className="absolute top-0 left-0 right-0 h-0.5 bg-white lg:bg-[#001731]" />
              <p className="text-xs font-inter text-[#6b7280] lg:text-[#636363] uppercase tracking-wider">Pipeline Value</p>
              <p className="text-2xl font-inter font-bold text-white lg:text-[#001731] mt-1">{formatCurrency(data.totalPipelineValue)}</p>
              <p className="text-xs font-inter text-[#6b7280] lg:text-[#636363] mt-1">Active deals</p>
            </div>
            <div className="relative bg-[#012144] lg:bg-white rounded-xl overflow-hidden p-5">
              <div className="absolute top-0 left-0 right-0 h-0.5 bg-[#5eead4] lg:bg-[#0d5959]" />
              <p className="text-xs font-inter text-[#6b7280] lg:text-[#636363] uppercase tracking-wider">New Listings</p>
              <p className="text-2xl font-inter font-bold text-white lg:text-[#001731] mt-1">{data.newListingsCount}</p>
              <p className="text-xs font-inter text-[#6b7280] lg:text-[#636363] mt-1">In selected period</p>
            </div>
            <div className="relative bg-[#012144] lg:bg-white rounded-xl overflow-hidden p-5">
              <div className="absolute top-0 left-0 right-0 h-0.5 bg-white lg:bg-[#001731]" />
              <p className="text-xs font-inter text-[#6b7280] lg:text-[#636363] uppercase tracking-wider">Win / Loss</p>
              <p className="text-2xl font-inter font-bold text-white lg:text-[#001731] mt-1">{data.dealsWon} / {data.dealsLost}</p>
              <p className="text-xs font-inter text-[#6b7280] lg:text-[#636363] mt-1">All time</p>
            </div>
          </>
        ) : null}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="relative bg-[#012144] lg:bg-white rounded-xl overflow-hidden p-5">
          <div className="absolute top-0 left-0 right-0 h-0.5 bg-[#5eead4] lg:bg-[#0d5959]" />
          <h3 className="font-inter text-sm font-medium text-white lg:text-[#001731] mb-4">Lead Sources</h3>
          {loading ? (
            <div className="space-y-2">
              {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="flex items-center gap-2">
                  <div className="h-2 w-20 bg-[#f7f8fa] rounded animate-pulse" />
                  <div className="h-2 flex-1 bg-[#f7f8fa] rounded animate-pulse" />
                </div>
              ))}
            </div>
          ) : data?.leadSources.length === 0 ? (
            <p className="text-sm font-inter text-[#6b7280] lg:text-[#636363]">No lead source data</p>
          ) : (
                ...
                return (
                  <div key={s.source}>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-xs font-inter text-[#9ca3af] lg:text-[#001731] capitalize">{s.source}</span>
                      <span className="text-xs font-inter text-[#6b7280] lg:text-[#636363]">{s.count}</span>
                    </div>
                    <div className="h-2.5 w-full bg-[#f7f8fa] rounded-full overflow-hidden">
        ...
        <div className="relative bg-[#012144] lg:bg-white rounded-xl overflow-hidden p-5">
          <div className="absolute top-0 left-0 right-0 h-0.5 bg-white lg:bg-[#001731]" />
          <h3 className="font-inter text-sm font-medium text-white lg:text-[#001731] mb-4">Lead Stages</h3>
          {loading ? (
            <div className="space-y-2">
              {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="flex items-center gap-2">
            ...
            <p className="text-sm font-inter text-[#636363]">No lead stage data</p>
          ) : (
            <div className="space-y-3">
              {data?.leadStages.map((s) => {
                ...
                return (
                  <div key={s.stage}>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-xs font-inter text-[#001731] capitalize">{s.stage}</span>
                      <span className="text-xs font-inter text-[#636363]">{s.count}</span>
                    </div>
                    <div className="h-2.5 w-full bg-[#f7f8fa] rounded-full overflow-hidden">
        ...
        <div className="relative bg-[#012144] lg:bg-white rounded-xl overflow-hidden p-5">
          <div className="absolute top-0 left-0 right-0 h-0.5 bg-[#5eead4] lg:bg-[#0d5959]" />
          <h3 className="font-inter text-sm font-medium text-white lg:text-[#001731] mb-4">Property Status</h3>
          {loading ? (
            <div className="space-y-2">
              {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="flex items-center gap-2">
            ...
            <p className="text-sm font-inter text-[#6b7280] lg:text-[#636363]">No property data</p>
          ) : (
            <div className="space-y-3">
              {data?.propertyStatus.map((s) => {
                ...
                return (
                  <div key={s.status}>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-xs font-inter text-[#001731] capitalize">{s.status.replace(/_/g, ' ')}</span>
                      <span className="text-xs font-inter text-[#636363]">{s.count}</span>
                    </div>
                    <div className="h-2.5 w-full bg-[#f7f8fa] rounded-full overflow-hidden">
                      <div className="h-full rounded-full bg-[#0d5959] transition-all" style={{ width: `${pct}%` }} />
        ...
        <div className="relative bg-[#012144] lg:bg-white rounded-xl overflow-hidden p-5">
          <div className="absolute top-0 left-0 right-0 h-0.5 bg-white lg:bg-[#001731]" />
          <h3 className="font-inter text-sm font-medium text-white lg:text-[#001731] mb-4">Property Purpose</h3>
          {loading ? (
            <div className="space-y-2">
            ...
            <p className="text-sm font-inter text-[#636363]">No property data</p>
          ) : (
            <div className="space-y-3">
              {data?.propertyPurpose.map((s) => {
                ...
                return (
                  <div key={s.purpose}>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-xs font-inter text-[#001731]">{s.purpose}</span>
                      <span className="text-xs font-inter text-[#636363]">{s.count}</span>
                    </div>
                    <div className="h-2.5 w-full bg-[#f7f8fa] rounded-full overflow-hidden">
                      <div className="h-full rounded-full bg-[#001731] transition-all" style={{ width: `${pct}%` }} />
      ...
      <div className="relative bg-[#012144] lg:bg-white rounded-xl overflow-hidden p-5">
        <div className="absolute top-0 left-0 right-0 h-0.5 bg-[#5eead4] lg:bg-[#0d5959]" />
        <h3 className="font-inter text-sm font-medium text-white lg:text-[#001731] mb-4">Top Properties by Views</h3>
        {loading ? (
          <div className="space-y-2">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="flex items-center gap-2">
                <div className="h-2 w-40 bg-[#f7f8fa] rounded animate-pulse" />
                <div className="h-2 flex-1 bg-[#f7f8fa] rounded animate-pulse" />
              </div>
            ))}
          </div>
        ) : data?.topProperties.length === 0 ? (
          <p className="text-sm font-inter text-[#6b7280] lg:text-[#636363]">No property view data yet.</p>
        ) : (
          <div className="space-y-3">
            {data?.topProperties.map((p) => {
              ...
              return (
                <div key={p.id}>
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-xs font-inter text-[#001731]">{p.title}</span>
                    <span className="text-xs font-inter text-[#636363]">{p.views} views</span>
                  </div>
                  <div className="h-2.5 w-full bg-[#f7f8fa] rounded-full overflow-hidden">
                    <div className="h-full rounded-full bg-[#0d5959] transition-all" style={{ width: `${pct}%` }} />
                  </div>
